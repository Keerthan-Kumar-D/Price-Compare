...
class MeeshoScraper:
    def __init__(self, headless=True):
        ...
        try:
            ...
            print("Initializing ChromeDriver for Meesho...")
    ...
    def scrape(self, query, scroll_count=3):
        ...
        try:
            ...
            time.sleep(3)  # Give more time for Meesho to load
            
            # Single scroll for speed
            print("Scrolling once for speed...")
...
def search_meesho(query, headless=True, scroll_count=3):
    ...
    try:
        ...
        products = scraper.scrape(query, scroll_count=scroll_count)
        return products if products is not None else []
    except Exception as e:
        print(f"Error in search_meesho: {e}")
        import traceback
        traceback.print_exc()
        return []
